...
public class SnapshotServiceTest {
    ...
    class GetSnapshotsByNoteId {
        ...
        void whenNoteDoesNotExist_thenThrowNoteNotFoundException() {
            ...
            NoteNotFoundException ex =
                    assertThrows(NoteNotFoundException.class, () -> snapshotService.getSnapshotsByNoteId(NOTE_ID));
    ...
    class RestoreSnapshot {
        ...
        void whenNoteDoesNotExist_thenThrowNoteNotFoundException() {
            ...
            // When & Then
            NoteNotFoundException ex =
                    assertThrows(NoteNotFoundException.class, () -> snapshotService.restoreSnapshot(NOTE_ID, SNAPSHOT_ID));
        ...
        void whenSnapshotDoesNotExist_thenThrowSnapshotNotFoundException() {
            ...
            NoteSnapshotNotFoundException ex =
                    assertThrows(NoteSnapshotNotFoundException.class,
